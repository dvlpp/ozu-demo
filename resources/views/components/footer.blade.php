<footer>
    <div class="mt-24 flex flex-col items-center mb-12">
        ...
        <div class="mb-2 p-6 text-sm text-gray-500 dark:text-gray-400 text-center">
            <div>
                This website is a demo <a href="https://ozu.code16.fr" class="underline font-bold">made with Ozu</a>,
                a full solution to deploy static websites from a standard Laravel codebase, with a custom CMS.
            </div>
        </div>
    </div>
</footer>
